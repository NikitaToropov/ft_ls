...
/*   Updated: 2021/01/10 14:04:02 by cmissy           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** All flags. TODO dont forget about '1' flag
*/
# define FLAGS					"lRartuUfg1"
...
** t_node comparators.
*/
char							compare_by_date(const t_node *first,
									const t_node *second);
char							compare_by_date_reverse(const t_node *first,
									const t_node *second);
char							compare_lexicographic(const t_node *first,
									const t_node *second);
char							compare_lexicographic_reverse(
									const t_node *first, const t_node *second);
...
void							dir_parser_facade(char **argv,
									unsigned short flags);
void							parse_the_dir(t_node *parent,
...
t_node							*quick_sort_nodes_recur(t_node *head,
									t_node *end, char comparator(const t_node *,
									const t_node *));

/*
** Printing.
*/
void							print_one_column(t_node *head,
									unsigned short flags);
